<template>
  <div class="privacy">
    ...
    <p>
      Wir erheben und speichern automatisch Informationen in Log Files, die
      Ihr Browser automatisch an uns übermittelt. Dies sind Browsertyp/
      Browserversion, verwendetes Betriebssystem, Referer URL und&nbsp;
      Uhrzeit der Serveranfrage. Diese Daten sind nicht bestimmten Personen
    ...
    <h4>Cookies</h4>
    <p>
      Die Internetseiten verwenden teilweise so genannte Cookies. Diese dienen
