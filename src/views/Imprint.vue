<template>
  <div class="imprint mt-5">
    ...
    <p>
      <span>Stephan Strittmatter</span><br>
      <span>Graf-Mangold-Str. 18</span><br>
      <span>78333 Stockach</span><br>
      <strong>Kontakt</strong><br>
      <span>E-Mail:&nbsp;kaufZwei@gmail.com</span>
    </p>
    ...
    <p>
      ...
      verpflichtet, &uuml;bermittelte oder gespeicherte fremde Informationen
    ...
    <p>
      ...
      k&ouml;nnen wir f&uuml;r diese fremden Inhalte auch keine Gew&auml;hr
      &uuml;bernehmen. F&uuml;r die Inhalte der verlinkten Seiten ist stets der
